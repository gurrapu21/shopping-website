...
insert into product (IN_STOCK ,PRODUCT_COST_ID , NAME,TYPE ) values (true, 2,'Turkey Towel', 'Towel');
...
insert into product (IN_STOCK ,PRODUCT_COST_ID ,NAME  	,TYPE ) values (true, 3,'Kurchif', 'cloth');
...
insert into product (IN_STOCK ,PRODUCT_COST_ID , NAME,TYPE ) values (true, 4,'Patu Saree', 'Saree');
